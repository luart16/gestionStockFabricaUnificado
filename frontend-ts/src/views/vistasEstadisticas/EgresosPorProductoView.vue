<template>
  <div v-if="store.Logueado" class="contenido-app">
    ...
    <div class="container py-4">
      ...
      <div>
        <GraficoPorProducto v-if="!cargando" :datos="movimientosFiltradosEgreso" color-barra="#573c9d"
          titulo-grafico="Top Productos Con Más Egresos" label-columna="Cantidad Egresada"
