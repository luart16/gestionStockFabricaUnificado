    ...
    <div class="container py-4">
      ...
      <div class="d-flex flex-wrap gap-3 mb-4">
        ...
        <div class="d-flex align-items-end">
          <button class="btn btn-gris-a-blanco" @click="filtrarPorFecha">
            Filtrar
          </button>
        </div>
      ...
      <div>
        <GraficoPorProducto v-if="!cargando" :datos="movimientosFiltradosIngreso" color-barra="#573c9d"
          titulo-grafico="Top Productos Con Más Ingresos" label-columna="Cantidad Ingresada"
          nombre-archivo-excel="Resumen_Ingresos_Productos" />
      </div>
    </div>
  </div>
