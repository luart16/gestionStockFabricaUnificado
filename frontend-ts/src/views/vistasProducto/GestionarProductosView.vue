        ...
        <div class="d-md-none">
          <div v-for="producto in productosExistentes" :key="'card-' + producto._id" class="card mb-3">
            <div class="card-body">
              ...
              <p class="card-text mb-1"><strong>M² por Molde:</strong> {{ Number(producto.m2PorMolde || 0).toFixed(2) }}</p>
              <p class="card-text mb-1"><strong>M² totales:</strong> {{ Number(producto.capacidadTotal || 0).toFixed(2) }}</p>
