  ...
  <div v-if="store.Logueado" class="contenido-app">
    ...
    <div class="container py-4">
      ...
      <div class="d-flex mb-4 flex-wrap gap-3 align-items-end">
        ...
        <input v-model="datoAFiltar" type="text" class="form-control" placeholder="Buscar por nombre o color"
        ...
        <div class="d-md-none">
          <div class="card mb-3" v-for="producto in productosExistentes" :key="producto._id">
            <div class="card-body">
